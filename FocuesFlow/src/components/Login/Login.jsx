  ...
  return (
    <div className={`${styles.page} ${isDarkMode ? styles.darkPage : ''}`}>
      ...
      <div className={`${styles.header} ${isDarkMode ? styles.darkHeader : ''}`}>
        ...
        <p className={`${styles.tagline} ${isDarkMode ? styles.darkTagline : ''}`}>Enter your sanctuary of productivity.</p>
      </div>

      <form className={`${styles.card} ${isDarkMode ? styles.darkCard : ''}`} onSubmit={handleSubmit}>
        {successMessage && (
          <div className={`${styles.successMessage} ${isDarkMode ? styles.darkSuccessMessage : ''}`}>
        ...
        {error && (
          <div className={`${styles.errorMessage} ${isDarkMode ? styles.darkErrorMessage : ''}`}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        <div className={`${styles.field} ${isDarkMode ? styles.darkField : ''}`}>
          <div className={styles.labelRow}>
            ...
            <Link to="/forgot-password" className={`${styles.forgotLink} ${isDarkMode ? styles.darkForgotLink : ''}`}>Forgot?</Link>
          </div>
          <div className={`${styles.inputWrap} ${isDarkMode ? styles.darkInputWrap : ''}`}>
            <svg className={`${styles.icon} ${isDarkMode ? styles.darkIcon : ''}`} width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        <div className={`${styles.checkboxRow} ${isDarkMode ? styles.darkCheckboxRow : ''}`}>
          <input
            type="checkbox"
            id="remember"
            checked={remember}
            onChange={() => setRemember(!remember)}
            className={`${styles.checkbox} ${isDarkMode ? styles.darkCheckbox : ''}`}
          />
      ...
      <div className={`${styles.footer} ${isDarkMode ? styles.darkFooter : ''}`}>
        <p className={`${styles.signupPrompt} ${isDarkMode ? styles.darkSignupPrompt : ''}`}>
          Don&apos;t have an account? <Link to="/signup" className={`${styles.signupLink} ${isDarkMode ? styles.darkSignupLink : ''}`}>Start your free trial</Link>
        </p>
        <p className={`${styles.copyright} ${isDarkMode ? styles.darkCopyright : ''}`}>© 2024 BrewTask. Crafted for focused minds.</p>
      </div>
    </div>
  )
}